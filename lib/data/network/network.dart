...
import 'package:eng_card_app/data/network/mockserver.dart';
...
class Network {
  ...
  Future<Response> makeHttpCall(Uri url, HttpMethod method,
    ...
    try {
      ...
      logger.d('RESPONSE <<<-- | $statusCode | ${url.path} | $data');
      ...
      logger.e("Network --> ${method.toString()}($url) | Connection Lost");
      logger.e(e.toString());
      logger.e(s.toString());
      return Response(ok: false);
    }
  ...
  Response mockServerHandler(
    ...
    logger.d('RESPONSE <<<-- | $statusCode | $path | $data');
